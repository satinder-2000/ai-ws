...
print("Plot the evolution of the weights over time:")
...
print()
print("Visualize how the trained model performs")
plt.plot(x, y, '.', label="Data")
plt.plot(x, f(x),label="Ground truth")
plt.plot(x, model(x), label="Predictions")
plt.legend()
...
print()
print("-----Same solution with Keras-----")
print()
...
print("use the built-in features of Keras as a shortcut")
