#Source: https://github.com/tensorflow/tensorflow/blob/v2.16.1/tensorflow/python/framework/tensor_conversion_registry.py#L80-L131
import collections
import threading
import numpy as np
                    ...
                    for base_type, conversion_func in get(type(value)):
                        ...
                        if dtype is None and preferred_dtype is not None:
                            try:
                                ...
                                if (
                                    ret is not NotImplemented
                                    and ret.dtype.base_dtype
                                    != preferred_dtype.base_dtype
                                ):
                                    raise RuntimeError(
                                        _add_error_prefix(
