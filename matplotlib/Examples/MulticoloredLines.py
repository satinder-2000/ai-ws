...
print("method is designed to give a smooth impression \nwhen distances and color differences between adjacent points are not too large.")    
print()
...
print("-----Color values between points-----")
print()
