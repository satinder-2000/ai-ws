...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul 19 00:37:11 2026

@author: singh
"""
print("SOURCE: https://matplotlib.org/stable/gallery/lines_bars_and_markers/marker_reference.html")
print()
...
print("-----Markers created from TeX symbols-----")
print()
fig, ax = plt.subplots()
...
print("-----Markers created from Paths-----")
print()
...
print("-----Advanced marker modifications with transform-----")
print()
...
print("-----Setting marker cap style and join style-----")
print()
...
print("-----Modifying the join style-----")
print()
